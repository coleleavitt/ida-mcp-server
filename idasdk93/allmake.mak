  ...
  ifeq ($(COMPILER_NAME),clang)
    ...
    ifndef MSVC_ROOT
      ifneq (,$(findstring Microsoft$(space)Visual$(space)Studio$(space),$(VCINSTALLDIR)))
        ifeq (,$(findstring 2022,$(VCINSTALLDIR)))
      ...
      $(eval $(call require_path,MSVC_ROOT,$(VCINSTALLDIR),Visual C++ 2022 Install Directory))
      export MSVC_ROOT
    endif

    # Visual C++ 2022 Tools Version
...
ifdef __NT__
  ...
  IDALIB_NAME = ida
  IDALIB_FULL_NAME = $(IDALIB_NAME)$(A)
  LINKIDA = $(L)$(IDALIB_FULL_NAME)

  IDALIBRARY_BASE = idalib
  IDALIBRARY_FULL_NAME = $(IDALIBRARY_BASE)$(SUFF32)$(A)
  LINKIDALIBRARY = $(L)$(IDALIBRARY_BASE)$(SUFF32)$(A)
else
  IDALIB_NAME = libida
  IDALIB_FULL_NAME = $(IDALIB_NAME)$(SUFF32)$(DLLEXT)
  LINKIDA = -L$(L) -lida$(SUFF32)

  IDALIBRARY_BASE = $(addprefix lib,$(IDALIBRARY_NAME))
  IDALIBRARY_FULL_NAME = $(IDALIBRARY_BASE)$(SUFF32)$(DLLEXT)
  LINKIDALIBRARY = -L$(L) -l$(IDALIBRARY_NAME)$(SUFF32)
endif
IDALIB = $(L)$(IDALIB_FULL_NAME)
IDALIBRARY = $(L)$(IDALIBRARY_FULL_NAME)
