...
//*****************************************************************************
// Required includes
#ifdef _WINDOWS_ // HEXRAYS - WINDOWS ONLY CODE
...
#define __out_opt
#include "corerror.h"
#endif // HEXRAYS - END OF WINDOWS ONLY CODE
...
DECLARE_INTERFACE_(IMetaDataEmit, IUnknown)
{
    STDMETHOD(SetModuleProps)(              // S_OK or error.
        LPCWSTR szName) PURE;               // [IN] If not nullptr, the name of the module to set.
...
DECLARE_INTERFACE_(IMetaDataAssemblyImport, IUnknown)
{
    ...
    STDMETHOD(FindAssembliesByName)(        // S_OK or error
        LPCWSTR  szAppBase,                 // [IN] optional - can be nullptr
        LPCWSTR  szPrivateBin,              // [IN] optional - can be nullptr
...
DECLARE_INTERFACE_(IMetaDataDispenserEx, IMetaDataDispenser)
{
    ...
    STDMETHOD(FindAssembly)(                // S_OK or error
        LPCWSTR  szAppBase,                 // [IN] optional - can be nullptr
        LPCWSTR  szPrivateBin,              // [IN] optional - can be nullptr
        LPCWSTR  szGlobalBin,               // [IN] optional - can be nullptr
        LPCWSTR  szAssemblyName,            // [IN] required - this is the assembly you are requesting
...
DECLARE_INTERFACE_(IMetaDataInfo, IUnknown)
{
    ...
    //   E_INVALIDARG       - If nullptr is passed as parameter.
