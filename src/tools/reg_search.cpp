        ...
        json find_register_access_impl(const json &params) {
            ...
            while (results.size() < static_cast<size_t>(limit)) {
                ...
                switch (out.access_type) {
                    case READ_ACCESS: access_str = "read";
                        break;
                    case WRITE_ACCESS: access_str = "write";
                        break;
                    case RW_ACCESS: access_str = "read_write";
                        break;
            ...
            def.input_schema = json{
                {"type", "object"},
                {
                    "properties", {
                        ...
                        {
                            "access_type",
                            {{"type", "string"}, {"description", "Type: read, write, or any (default: any)"}}
                        },
