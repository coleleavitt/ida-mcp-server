    ...
    void register_tools(mcp::McpServer &server) {
        ...
        def.input_schema = json{
            ...
            {"properties", {
                ...
                {"maturity", {
                    {"type", "integer"},
                    {"description", "Microcode maturity level 1-8 (default: 7 = GLBOPT3). Lower = closer to raw assembly, higher = more optimized."}
                }},
                {"max_instructions", {
                    {"type", "integer"},
                    {"description", "Max number of microinstructions to return (default: 500). Prevents huge outputs."}
                }}
            }},
