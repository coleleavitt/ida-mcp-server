    ...
    void register_tools(mcp::McpServer &server) {
        {
            ...
            def.description = "List entries in an IDA directory tree folder. Trees: funcs, names, imports, local_types, bookmarks, bpts";
            def.input_schema = json{
                {"type", "object"},
                {"properties", {
                    {"tree", {{"type", "string"}, {"description", "Tree name: funcs, names, imports, local_types, bookmarks, bpts"}}},
        ...
        }
        {
            ...
            def.input_schema = json{
                ...
                {"properties", {
                    ...
                    {"unlink", {{"type", "boolean"}, {"description", "If true, unlink from folder. Default: false (link/add)"}}}
                }},
                {"required", json::array({"tree", "path"})}
            };
